...
ADDR_from_Keys=$($CALL_TC genaddr $Wallet_Code --abi $Wallet_ABI --setkey ${KEY_FILES_DIR}/${KeysFileBaseName}_1.keys.json --wc "$Work_Chain" | grep "Raw address:" | awk '{print $3}')
